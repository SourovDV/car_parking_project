...
class ReservationPageOne extends StatefulWidget {
  const ReservationPageOne({super.key});

  @override
  State<ReservationPageOne> createState() => _ReservationPageOneState();
}

class _ReservationPageOneState extends State<ReservationPageOne> {
  @override
    ...
    return Scaffold(
      ...
      body: ListView.builder(
          ...
          itemBuilder: (context,index){
            return location_one_item(navigator:HomePage7());
          }),
