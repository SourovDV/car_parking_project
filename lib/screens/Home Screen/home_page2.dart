...
class ParkingFilterPage extends StatefulWidget {
  const ParkingFilterPage({super.key});

  @override
  State<ParkingFilterPage> createState() => _ParkingFilterPageState();
}

class _ParkingFilterPageState extends State<ParkingFilterPage> {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Row(
          ...
          children: [
            Icon(Icons.local_parking, color: Colors.redAccent),
